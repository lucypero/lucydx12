...
foreign lib {
	...
	GetContentScaleForWindow :: proc(window: ^sdl.Window) -> f32 ---
	GetContentScaleForDisplay :: proc(display_index: i32) -> f32 ---

	// Gamepad selection automatically starts in AutoFirst mode, picking first available SDL_Gamepad. You may override this.
	// When using manual mode, caller is responsible for opening/closing gamepad.
	SetGamepadMode :: proc(mode: GamepadMode, manual_gamepads_array: [^]^sdl.GameController = nil, manual_gamepads_count := i32(-1)) ---
